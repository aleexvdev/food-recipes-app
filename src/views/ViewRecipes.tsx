...
export const ViewRecipes = () => {
  ...
  return (
    <section className='bg-white w-full h-auto 2xl:h-auto lg:h-auto md:h-auto text-white 2xl:pb-20 lg:pb-20 2xl:px-52 lg:px-28 lg:py-20 md:py-20 md:px-16 px-4 py-10'>
      <div className="w-full h-full flex flex-col items-center justify-center container bg-white">
        <div className="w-full h-full flex flex-col items-center justify-center">
          <h1 className="2xl:text-5xl lg:text-4xl md:text-4xl text-4xl text-green-600 font-bold mb-3">Explore Our Foods</h1>
          <p className="text-center 2xl:text-2xl lg:text-3xl md:text-2xl text-2xl text-gray-800 font-semibold 2xl:mt-5 lg:mt-[4rem] md:mt-[3rem] mt-5 2x:px-24 px-0">Explore diverse recipes for breakfast, lunch, dinner, drinks, and desserts all in one place.</p>
          <div className="w-full h-full flex 2xl:flex-row flex-col items-center justify-center 2xl:px-0 2xl:mt-14 my-5">
            <div 
              className="w-full 2xl:w-[80%] h-full flex flex-col 2xl:flex-row md:flex-row 2xl:flex-wrap items-center justify-center gap-10 mt-10 2xl:mt-0 2xl:px-0"
            >
              {
                recipes?.hits &&
