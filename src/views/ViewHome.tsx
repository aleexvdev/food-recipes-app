...
export const ViewHome = () => {
  ...
  return (
    <section className="w-full h-auto 2xl:h-[calc(100vh-80px)] px-4 2xl:px-52 lg:px-40 pt-20 2xl:pt-0 lg:pt-5">
      <div className="w-full h-full flex flex-col-reverse 2xl:flex-row lg:flex-row items-center justify-center lg:gap-10">
        ...
        <div className="w-full 2xl:w-[50%] lg:w-[50%]">
          <div className="w-full flex flex-col justify-center items-center text-center">
            <div className="w-full my-3">
              <h1 className="font-bold"><span className='2xl:text-7xl lg:text-6xl md:text-[90px] text-5xl md:mr-6 lg:mr-6 2xl:mr-6 mr-0'>Health Requires</span></h1>
              <h1 className="font-bold"><span className='2xl:text-7xl lg:text-6xl md:text-[90px] text-5xl md:mr-6 lg:mr-6 2xl:mr-6 mr-0'>Healthy food</span></h1>
              <p className="mt-4 font-semibold text-2xl 2xl:text-3xl lg:text-2xl">Manage your recipes the easy way</p>
            </div>
            <div className="mt-5">
